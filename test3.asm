...
int main()
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
    sleep(100);
  11:	6a 64                	push   $0x64
  13:	e8 fa 02 00 00       	call   312 <sleep>
    printf(1, "Test3\n");
  18:	58                   	pop    %eax
  19:	5a                   	pop    %edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 594:	e9 8f fe ff ff       	jmp    428 <printf+0x48>
          s = "(null)";
 599:	bb 3f 07 00 00       	mov    $0x73f,%ebx
        while(*s != 0){
 ...
 5b1:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 ec 09 00 00       	mov    %eax,0x9ec
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 ec 09 00 00       	mov    %eax,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6e7:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 ...
 6f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 ec 09 00 00 f0 	movl   $0x9f0,0x9ec
 707:	09 00 00 
 70a:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 711:	09 00 00 
    base.s.size = 0;
 714:	b8 f0 09 00 00       	mov    $0x9f0,%eax
 719:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 720:	00 00 00 
