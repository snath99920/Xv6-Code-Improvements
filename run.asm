 ...
 369:	85 d2                	test   %edx,%edx
{
 ...
 3d0:	e8 ed fe ff ff       	call   2c2 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 4a1:	e8 1c fe ff ff       	call   2c2 <write>
 ...
 4b8:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 4ba:	e8 03 fe ff ff       	call   2c2 <write>
  for(i = 0; fmt[i]; i++){
 ...
 553:	57                   	push   %edi
 554:	53                   	push   %ebx
 555:	e8 68 fd ff ff       	call   2c2 <write>
        while(*s != 0){
 ...
 5a7:	e8 16 fd ff ff       	call   2c2 <write>
        ap++;
 ...
 5b4:	e9 8f fe ff ff       	jmp    448 <printf+0x48>
          s = "(null)";
 5b9:	bb 67 07 00 00       	mov    $0x767,%ebx
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6be:	56                   	push   %esi
 6bf:	e8 66 fc ff ff       	call   32a <sbrk>
  if(p == (char*)-1)
