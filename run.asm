...
int main(int argc, char * argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    int pid;//, x = 0;
    if((pid = fork())==0){
  11:	e8 84 02 00 00       	call   29a <fork>
  16:	85 c0                	test   %eax,%eax
  18:	74 1d                	je     37 <main+0x37>
        // }
        // x = x + 12*21;
        sleep(5);
    }
  ...
  1d:	6a 04                	push   $0x4
  1f:	e8 0e 03 00 00       	call   332 <sleep>
  ...
  24:	58                   	pop    %eax
  25:	5a                   	pop    %edx
  26:	68 48 07 00 00       	push   $0x748
  2b:	6a 01                	push   $0x1
  2d:	e8 be 03 00 00       	call   3f0 <printf>
    exit();
  32:	e8 6b 02 00 00       	call   2a2 <exit>
        sleep(5);
  37:	83 ec 0c             	sub    $0xc,%esp
  3a:	6a 05                	push   $0x5
  3c:	e8 f1 02 00 00       	call   332 <sleep>
  41:	83 c4 10             	add    $0x10,%esp
  44:	eb d4                	jmp    1a <main+0x1a>
  46:	66 90                	xchg   %ax,%ax
  48:	66 90                	xchg   %ax,%ax
  4a:	66 90                	xchg   %ax,%ax
  4c:	66 90                	xchg   %ax,%ax
 ...
 359:	85 d2                	test   %edx,%edx
{
 ...
 387:	f7 f1                	div    %ecx
 389:	0f b6 92 60 07 00 00 	movzbl 0x760(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	e9 8f fe ff ff       	jmp    438 <printf+0x48>
          s = "(null)";
 5a9:	bb 57 07 00 00       	mov    $0x757,%ebx
        while(*s != 0){
 ...
 5c1:	a1 04 0a 00 00       	mov    0xa04,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 04 0a 00 00       	mov    %eax,0xa04
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 04 0a 00 00    	mov    0xa04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 04 0a 00 00    	cmp    %eax,0xa04
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 04 0a 00 00    	mov    0xa04,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 04 0a 00 00    	mov    %edx,0xa04
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 04 0a 00 00 08 	movl   $0xa08,0xa04
 717:	0a 00 00 
 71a:	c7 05 08 0a 00 00 08 	movl   $0xa08,0xa08
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 08 0a 00 00       	mov    $0xa08,%eax
 729:	c7 05 0c 0a 00 00 00 	movl   $0x0,0xa0c
 730:	00 00 00 
