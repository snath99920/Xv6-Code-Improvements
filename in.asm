...
int main(int argc, char * argv[])
{
  ...
  13:	8b 71 04             	mov    0x4(%ecx),%esi
    ...
    int wt, rt;
    if((pid=fork())==0){
  16:	e8 bf 02 00 00       	call   2da <fork>
  ...
  27:	e8 ee 02 00 00       	call   31a <exec>
        printf(1, "Exec %s failed\n", argv[1]);
  2c:	83 c4 0c             	add    $0xc,%esp
  2f:	ff 76 04             	pushl  0x4(%esi)
  32:	68 88 07 00 00       	push   $0x788
  37:	6a 01                	push   $0x1
  39:	e8 f2 03 00 00       	call   430 <printf>
  ...
  5a:	e8 83 02 00 00       	call   2e2 <exit>
        stat = waitx(&wt, &rt);
  5f:	50                   	push   %eax
  60:	50                   	push   %eax
  ...
  68:	50                   	push   %eax
  69:	e8 14 03 00 00       	call   382 <waitx>
        sleep(10);
  6e:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
        stat = waitx(&wt, &rt);
  75:	89 c3                	mov    %eax,%ebx
        sleep(10);
  77:	e8 f6 02 00 00       	call   372 <sleep>
  7c:	83 c4 10             	add    $0x10,%esp
  7f:	eb c0                	jmp    41 <main+0x41>
  81:	66 90                	xchg   %ax,%ax
  83:	66 90                	xchg   %ax,%ax
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
 ...
 399:	85 d2                	test   %edx,%edx
{
 ...
 3c7:	f7 f1                	div    %ecx
 3c9:	0f b6 92 cc 07 00 00 	movzbl 0x7cc(%edx),%edx
  }while((x /= base) != 0);
