...
main(int argc, char* argv[])
{
  ...
  1e:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
  25:	89 45 d4             	mov    %eax,-0x2c(%ebp)
  28:	90                   	nop
  ...
  39:	e8 42 02 00 00       	call   280 <atoi>
  3e:	69 c0 40 42 0f 00    	imul   $0xf4240,%eax,%eax
  44:	8b 4d e0             	mov    -0x20(%ebp),%ecx
  47:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
  4a:	83 c4 10             	add    $0x10,%esp
  4d:	89 c7                	mov    %eax,%edi
  4f:	c1 ff 1f             	sar    $0x1f,%edi
  52:	39 df                	cmp    %ebx,%edi
  54:	7f 2e                	jg     84 <main+0x84>
  56:	7d 28                	jge    80 <main+0x80>
    {
        x++;
    }
    printf(1,"%d\n", atoi(argv[1]));
  58:	8b 45 d4             	mov    -0x2c(%ebp),%eax
  5b:	83 ec 0c             	sub    $0xc,%esp
  5e:	ff 70 04             	pushl  0x4(%eax)
  61:	e8 1a 02 00 00       	call   280 <atoi>
  66:	83 c4 0c             	add    $0xc,%esp
  69:	50                   	push   %eax
  6a:	68 a8 07 00 00       	push   $0x7a8
  6f:	6a 01                	push   $0x1
  71:	e8 da 03 00 00       	call   450 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb ac 07 00 00       	mov    $0x7ac,%ebx
        while(*s != 0){
