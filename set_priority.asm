...
_set_priority:     file format elf32-i386
  ...
  13:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  71:	53                   	push   %ebx
  72:	56                   	push   %esi
  73:	e8 02 03 00 00       	call   37a <set_priority>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb d5 07 00 00       	mov    $0x7d5,%ebx
        while(*s != 0){
